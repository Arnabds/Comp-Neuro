...
<p>
    Now we have simulated the neurons of 9D model with proper parameters and we get
...
<p>
    If we simulate the population model neurons with proper parameters and we get
    <p><img src="images/sevstpop.png" alt="neuron population spiking diagrams"></p>
  <figcaption>Oscillation changes with external current.The parameters are just as above, only we injected inhibition ampi=5 at t=500 to go to the lower limit cycle then we injected inhibition ampe=5 at t=1250 to go to the bigger limit cycle and lastly, we injected inhibition amps=5 at t=2050 to go to the lower limit cycle again. Here the duration of the impulse is wid=100.</figcaption>
</p>
